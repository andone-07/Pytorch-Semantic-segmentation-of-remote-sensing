...
import glob
dataset = OurDataset(
    glob.glob(r'F:\Desktop\computer-vision-group-project-master\data\round1_train\*.tif'),
    glob.glob(r'F:\Desktop\computer-vision-group-project-master\data\round1_train\*.png'),
    "train",
    True
)
